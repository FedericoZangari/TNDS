...
int main(int argc, const char ** argv){
	...
	cout << fixed << setprecision(12) << "Valore dell'integrale con metodo Midpoint: " << integrator->Midpoint(nstep) <<endl << endl;
	
	cout << "Errors table Midpoint" << endl;
	cout << "Nstep \t\t" << "Error" << endl;

	for(int i = 1; i<= 10; i++){
		cout << setprecision(0) << setw(15) << left << pow(2,i) <<  setprecision(12) << abs(I - integrator->Midpoint(pow(2,i)) ) << endl;
	}
    ...
    cout << endl << fixed << setprecision(12) << "Valore dell'integrale con metodo Midright: " << integrator->Midright(nstep) <<endl << endl;
	
	cout << "Errors table Midright" << endl;
	cout << "Nstep \t\t" << "Error" << endl;

	for(int i = 1; i<= 10; i++){
		cout << setprecision(0) << setw(15) << left << pow(2,i) <<  setprecision(12) << abs(I - integrator->Midright(pow(2,i)) ) << endl;
	}
	...
	cout << setprecision(3) <<"Ordine di convergenza del metodo Midright: " << endl;
    cout << "k1:\t" << k11 << endl << "k2:\t" << k22 << endl;
    ...
    cout << "Errore metodo della media: " << eps_ave16 << endl;
    ...
    cout << "Punti necessari per ottenere con il metodo della media la stessa precisione che si ottiene con il metodo midpoint a 16 punti: " << endl;
    cout << N_ave << endl;
